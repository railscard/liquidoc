# https://github.com/locomotivecms/engine/blob/master/lib/locomotive/liquid/filters/date.rb
    ...
    module Date
      ...
      def localized_date(input, *args)
        ...
        ::I18n.with_locale(locale) do
          ...
          input = input.in_time_zone(Time.zone) if input.respond_to?(:in_time_zone)
